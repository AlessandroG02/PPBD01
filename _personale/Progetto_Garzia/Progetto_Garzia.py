...
smtp_port = 587
sender_email = 'indirizzo.HRR1@outlook.it'
...
for nome in nomi_curriculum:       # personalizzare il nome del file cv in modo che alleghi il cv di ciascun candidato
    #percorso_cv = f'C:/Users/Utente/Documents/Progetto_Garzia/ACE10001I C-Lab HR/CV al Cliente/cv_{cognome_nome}.pdf'
    attach_file(f'C:/Users/Utente/Documents/Progetto_Garzia/ACE10001I C-Lab HR/CV al Cliente/{cognome_nome} (Fabio).docx')


attach_file('C:/Users/Utente/Documents/Progetto_Garzia/ACE10001I C-Lab HR/DB C-Lab_(Transfer).xlsx')
